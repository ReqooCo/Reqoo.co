(()=>{
'use strict';
if(!document.querySelector('link[href*="/admin/admin-flow-v1.css"]')){const l=document.createElement('link');l.rel='stylesheet';l.href='/admin/admin-flow-v1.css?v=1';document.head.appendChild(l)}
