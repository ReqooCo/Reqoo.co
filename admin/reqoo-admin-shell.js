(()=>{
  ...
  const isDocs=p==='/admin/documents.html';
  const isSecurity=p==='/admin/settings.html';
  const isMain=p==='/'||p==='/admin'||p==='/admin/index.html';
  const active=isShop?'shop':isPksk?'pksk':isDocs?'documents':isSecurity?'security':isMain?'overview':'';
  ...
  nav.innerHTML=`<div class="rq-admin-shell-inner"><a class="rq-admin-brand" href="/admin/">REQOO<span>.ADMIN</span></a>${back}<div class="rq-admin-links"><a data-a="overview" href="/admin/">Overview</a><a data-a="shop" href="/shop/admin.html">SHOP</a><a data-a="documents" href="/admin/documents.html">DOCUMENTS</a><a data-a="pksk" href="/admin/sim-v2.html">PKSK</a><a data-a="security" href="/admin/settings.html">SECURITY</a></div><div class="rq-admin-live"><i></i> ADMIN</div></div>`;
