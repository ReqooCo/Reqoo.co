...
export const catalogAuth = Object.freeze({
  getKey: adminKey,
  setKey: (key) => { const value=String(key||''); if(!value)return catalogAuth.clear(); try{localStorage.setItem('reqoo_admin_key',value)}catch{} try{sessionStorage.setItem('reqoo_admin_key',value)}catch{} },
