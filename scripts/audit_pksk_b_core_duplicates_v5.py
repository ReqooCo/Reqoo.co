...
def main()->int:
    base.SOURCE=base.OUT/'b_section_selected_after_batch004.jsonl'
    ...
    if summary_path.exists():
        ...
        data['version']='B_CORE_DUPLICATE_AUDIT_V5_AFTER_BATCH004'
        data['sourceFile']='audit-output/b_section_selected_after_batch004.jsonl'
        ...
        if data.get('hardUniqueCoreSource')!=789:
            print('EXPECTED_UNIQUE_AFTER_BATCH004=789, GOT',data.get('hardUniqueCoreSource')); return 2
        if data.get('minimumNewOrMaterialRewriteRequired')!=2711:
            print('EXPECTED_REMAINING_AFTER_BATCH004=2711, GOT',data.get('minimumNewOrMaterialRewriteRequired')); return 2
    return rc
