...
assert.match(html,/documents-overdue-v1\.css\?v=2/);
...
assert.match(overdueCss,/rqReminderBtn/);assert.match(overdueCss,/rqFinanceResultsPanel/);assert.match(overdueCss,/rqFinanceInvoiceRow/);
