...
assert.match(html,/document-deposit-note-v1\.js\?v=1/);
assert.match(html,/document-deposit-note-v1\.css\?v=1/);
...
assert.match(depositCss,/Deposit diperlukan untuk mengesahkan tempahan/);
...
assert.match(publicHtml,/document-deposit-note-v1\.js\?v=1/);
assert.match(publicHtml,/document-deposit-note-v1\.css\?v=1/);
...
console.log('PASS: Documents supports custom quotations, conversion, legal branding, A4-first layout and default deposit payment terms.');
