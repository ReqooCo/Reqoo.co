...
assert.match(ui,/createCustomQuotation/);assert.match(ui,/QUANTITY \(UNIT\)/);assert.match(ui,/PRICE \/ UNIT \(RM\)/);assert.match(ui,/data-q-calc/);
...
assert.match(publicHtml,/document-public-v1\.js\?v=6/);
...
assert.match(publicUi,/quoteMeta/);assert.match(publicUi,/function paymentTerms/);assert.match(publicUi,/rqPaperPaymentTerms/);
