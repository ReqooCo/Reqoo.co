...
assert.match(worker,/shop-admin-flow-v15\.js/,'API worker must route Shop Admin through v15');assert.match(v15,/shop-admin-flow-v14\.js/);assert.match(v14,/shop-admin-flow-v13\.js/,'v14 must preserve v13 -> v12 Documents chain');
...
console.log('PASS: Documents V2 remains preserved behind v15.');