...
assert.match(html,/documents\.js\?v=3/);
assert.match(html,/documents\.css\?v=2/);
assert.match(html,/documents-payment-v1\.js\?v=1/);
assert.match(html,/documents-drawer-v1\.js\?v=1/);
...
assert.match(paymentJs,/listPayments/);
assert.match(drawerJs,/DOCUMENT FLOW/);
assert.match(drawerJs,/Payment Timeline/);
assert.match(drawerJs,/paymentSummary/);
assert.match(drawerJs,/listPayments/);
...
assert.match(publicHtml,/document-public-v1\.js\?v=5/);
assert.match(publicHtml,/document-public-v1\.css\?v=5/);
