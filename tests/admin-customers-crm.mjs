...
assert.match(html,/CUSTOMER CRM/);assert.match(html,/LIFETIME COLLECTED/);assert.match(html,/statOutstanding/);assert.match(html,/customers\.js\?v=2/);assert.match(html,/customers\.css\?v=1/);
...
assert.match(worker,/settings\|documents\|customers/);assert.match(worker,/admin-shell\.js\?v=2/);
