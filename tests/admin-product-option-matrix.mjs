...
assert.match(html,/product-option-matrix\.js\?v=4/,'Products editor must load latest options-first helper');
assert.match(html,/product-options\.css\?v=2/,'Products editor must load latest options-first styling');
