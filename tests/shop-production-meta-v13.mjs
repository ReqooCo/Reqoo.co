...
assert.match(v14,/shop-admin-flow-v13\.js/);assert.match(v15,/shop-admin-flow-v14\.js/);assert.match(worker,/shop-admin-flow-v15\.js/);assert.match(migration,/shop_production_meta/);assert.match(migration,/REFERENCES orders\(id\) ON DELETE CASCADE/);
console.log('PASS: production metadata remains admin-authenticated and preserved behind v15.');