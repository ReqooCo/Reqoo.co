...
assert.match(api,/onRequestPost as handleCustomer/,'API worker must import the actual customer-v1 POST handler export');
assert.match(api,/onRequest as handleOrder/,'API worker must import order-v1 handler');
...
console.log('PASS: tumbler checkout proxy preserves request body and deployable core order routes are wired.');
