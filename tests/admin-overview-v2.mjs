...
assert.match(js,/COMMAND CENTER/);assert.match(js,/TODAY COLLECTED/);assert.match(js,/OUTSTANDING/);assert.match(js,/TO PRODUCE/);assert.match(js,/DUE IN 7 DAYS/);assert.match(js,/OVERDUE INVOICES/);assert.match(js,/Customer terbaru/);
