...
assert.match(html,/quotation/i);assert.match(html,/invoice/i);assert.match(html,/receipt/i);assert.match(html,/documents\.js\?v=2/);
assert.match(js,/listOrders/);assert.match(js,/listDocuments/);assert.match(js,/Pautan rasmi REQOO\.CO/);assert.match(js,/\+'\?v='\+rev/,'WhatsApp links must use a preview-cache revision');assert.match(js,/createDocument/);assert.match(js,/saveDocumentSettings/);assert.match(js,/w\.print\(\)/);
