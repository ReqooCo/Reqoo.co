...
const v9=fs.readFileSync(new URL('../api/shop-admin-flow-v9.js',import.meta.url),'utf8');assert.match(v9,/shop-admin-flow-v8\.js/);assert.match(v9,/status==='processing'\|\|status==='fulfilled'/);assert.match(v9,/\['paid','partial'\]/,'Deposit must permit production status changes');
