...
assert.match(html,/PRODUCTION CONTROL/);assert.match(html,/production-v1\.js/);assert.match(html,/admin-flow-v1\.css\?v=2/);assert.match(html,/admin-shell-v2\.js\?v=6/);
