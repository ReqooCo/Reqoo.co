...
async function load(n=setNo){
 const requested=Math.max(1,Math.min(50,Number(n)||1));
...
function beginABBriefing(){ if(!pkskLicense()){location.href='../access/';return;} 
